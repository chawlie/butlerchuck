        ...
        <header class="mobile-header">
            <div class="row">
                <div class="top-bar" data-responsive-toggle="mobile-nav" data-hide-for="none" data-toggle>
                        <a href="/" class="mobile-logo" title="Go to <?php bloginfo('name'); ?> Home Page"><img src="<?php bloginfo('template_url'); ?>/site/images/butler_chuck_logo.svg" alt="<?php bloginfo('name'); ?>" /></a>
